...
export default function RepositoryErrorPage({
  reset,
}: {
  ...
  return (
    <DashboardContainer>
      <div className="mx-auto max-w-lg space-y-6 rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <ErrorMessage message="Something went wrong loading this repository." />
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          The repository may not exist or the server encountered an error.
        </p>
